...
() {
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_COMMITS_AHEAD || VCS_STATUS_COMMITS_BEHIND || VCS_STATUS_PUSH_COMMITS_AHEAD || VCS_STATUS_PUSH_COMMITS_BEHIND || VCS_STATUS_STASHES || VCS_STATUS_ACTION || VCS_STATUS_NUM_CONFLICTED || VCS_STATUS_NUM_STAGED || VCS_STATUS_NUM_UNSTAGED || VCS_STATUS_NUM_UNTRACKED )) && res+=" %1F%B[%b%f"
